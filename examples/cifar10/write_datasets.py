...
def main(train_dataset, val_dataset):
    datasets = {
        'train': torchvision.datasets.CIFAR10('/tmp/datasets/cifar_ffcv', train=True, download=True),
        'test': torchvision.datasets.CIFAR10('/tmp/datasets/cifar_ffcv', train=False, download=True)
        }
